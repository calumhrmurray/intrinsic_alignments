...
def load_displacement_catalogues():
    ...
    velocity_folder = '/n17../results/correlation_functions/murray/desi_../results/correlation_functions/DESI/velocity_catalogues/'
...
def main():
    ...
    print("- ../../results/figures/validation/displacement_vectors_sky_patch.png")
    print("- ../../results/figures/validation/displacement_vectors_physical_scale.png")
    print("- ../../results/figures/validation/displacement_distributions_lines.png") 
    print("- ../../results/figures/validation/displacement_magnitude_analysis.png")
