#!/bin/bash
#SBATCH --output=/n17data/murray/desi_data/DESI/correlation_function_logs/displacement_shear_correlation_%j.out
#SBATCH --error=/n17data/murray/desi_data/DESI/correlation_function_logs/displacement_shear_correlation_%j.err
